        ...
        if (len > 0) {
            for (var i = startPos; i < endPos; i++) {
                ...
                if (jsonObject.active) {
                    ...
                    if (userAccountAccess.type == 'ADMIN' || userAccountAccess.type == 'MANAGER') {
                        html += '<td><a data-toggle="modal" data-id="' + jsonObject.mail + '" href="#addAccount" class="openAddAccount">Yes</a></td>';
                    }
                    else {
                        html += '<td>Yes</td>';
                    }
